...
Polymer({
      ...
      properties: {
        ...
        /**
         * Whether the button is in the paused state.
         * @type {boolean}
         */
        paused: {
          type: Boolean,
       ...
       * @private
       */
      computeIcon_: function(paused, loading) {
        return loading || paused ? 'av:pause' : 'sj:play-arrow';
      },
      ...
      computeHoverIcon_: function(playing) {
        return playing ? 'av:pause' : 'sj:play-arrow';
      },
...
Polymer({
      ...
      properties: {
        ...
        /**
         * Whether the card is in the loading state.
         * @type {boolean}
         */
        loading: {
          type: Boolean,
        ...
        /**
         * Whether the card is in the playing state.
         * @type {boolean}
         */
        playing: {
          type: Boolean,
        ...
        /**
         * Whether the card is in the paused state.
         * @type {boolean}
         */
        paused: {
          type: Boolean,
