...
return false;} 
$DC.document=$DC.window.document;
if($DC.settings){}else{$DC.settings={};}
var _default=function(_setting,_default_value){if($DC.settings[_setting]){}else{$DC.settings[_setting]=_default_value;}};
var $=$DC.jQuery;$DC.site=false;
$DC.debug=($DC.debug||false);$DC.debugRemembered={};if($DC.debug)
{
switch(true)
...
$DC.logOneline('-----------------------------------------');};
$DC.debugRemember=function(_k,_v)
...
{var _replace={"&":"amp",'"':"quot","<":"lt",">":"gt"};return((_string&&_string.replace)?_string.replace(/[&"<>]/g,function(_match){return("&"+_replace[_match]+";");}):'');};
$DC.parser__jQueryFindInDocument=function(_expression)
...
_html=_html.replace(/<\s+/gi,'<');_html=_html.replace(/\s+>/gi,'>');_html=_html.replace(/\s+\/>/gi,'/>');
_html=_html.replace(/<script[^>]*?>([\s\S]*?)<\/script>/gi,'');_html=_html.replace(/<script[^>]*?\/>/gi,'');_html=_html.replace(/<noscript[^>]*?>([\s\S]*?)<\/noscript>/gi,'');return _html;};
$DC.sites={'amazon':{'rules':{'main':'^http://www[.]amazon[.](com|co[.]uk|ca|com[.]au|de|fr|es|it|nl|co[.]jp|cn|com[.]br|com[.]mx|in)/([^/]+/)?dp/[^/]{10}','secondary':'^http://www[.]amazon[.](com|co[.]uk|ca|com[.]au|de|fr|es|it|nl|co[.]jp|cn|com[.]br|com[.]mx|in)/gp/product/[^/]{10}'},'validators':{'main':function(_rule){switch(true){case($DC.document.body&&$DC.document.body.id&&($DC.document.body.id=='dp')):return'main';break;case($DC.document.body&&!$DC.document.body.id&&$DC.document.body.className&&($DC.document.body.className=='dp')):return'kindle';break;}
...
{_is_video=((_stuff.indexOf('play-button')>-1)||(_file=='video'));return'/'+_file+'.'+_extension;}))+'';if(_item&&!_is_video){_return.push(_item);}
});return _return;})(),'bullets':(function()
...
_return=((_return&&_return.replace)?_return.replace(/<(img|hr)[^>]+[\/]?>/gi,"\n\n"):_return);return _return;})()),'technical_details':(function()
...
_nnl(_$this.attr('src').replace(/[\/]([^.\/]+?)[.][_]([^.\/]+?)[_][.](jpg|png|gif)$/gi,function(_whole,_file,_stuff,_extension)
{_is_video=((_stuff.indexOf('play-button')>-1)||(_file=='video'));return'/'+_file+'.'+_extension;}))+'';if(_item&&!_is_video){_return.push(_item);}
});return _return;})(),'reviews':(function()
{var _return=[];$find('#revMHRL > div').each(function()
{var _$this=$(this),_item={'stars_icon':_nnl((function()
...
'rules':{'main':'^http[s]?://www[.]linkedin[.]com/profile/view[?][\S]*id=([0-9]{2,10})','vanity':'^http[s]?://(www)|([a-z]{2})[.]linkedin[.]com/in/([^/]+)$','public':'^http[s]?://(www)|([a-z]{2})[.]linkedin[.]com/pub/([^/]+)/'},'validators':{'main':function(_rule){if($DC.document.body&&$DC.document.body.id&&$DC.document.body.id.indexOf&&($DC.document.body.id.indexOf('profile')>-1)){}else{return false;}
...
if(_return_endorsements.length>=3){return false;}});return _return_endorsements;})()};if(_item_position.position_and_company&&_item_position.endorsements.length){_return_positions.push(_item_position);}
if(_return_positions.length>=3){return false;}});return _return_positions;})()};}
}
},'youtube':{'rules':{'main':'^http[s]?://www[.]youtube[.]com/watch[?][\S]*v=([a-z0-9_-]{5,20})'},'validators':{'main':function(_rule){if($DC.document.body&&$DC.document.body.id&&($DC.document.body.id=='body')&&$DC.document.getElementById&&$DC.document.getElementById('player')){}else{return false;}
...
if(_return.length>=10){return false;}});return _return;})()};}
}
}
};
 for(var _site in $DC.sites){for(var _rule in $DC.sites[_site].rules){$DC.sites[_site].rules[_rule]=new RegExp($DC.sites[_site].rules[_rule],'gi');}}
$DC.check=function()
